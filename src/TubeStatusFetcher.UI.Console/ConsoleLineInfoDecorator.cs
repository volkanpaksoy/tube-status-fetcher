...
{
    public class ConsoleLineInfoDecorator
    {
        ...
        public ConsoleLineInfoDecorator(LineInfo lineInfo)
        {
            LineInfo = lineInfo;
            InitColours();
        }
        ...
        public ConsoleColor BackColour
        {
            get
            {
                return _tubeBGColourDictionary[this.LineInfo.Id];
            }
        }
        ...
        public ConsoleColor ForeColour
        {
            get
            {
                return _tubeFGColourDictionary[this.LineInfo.Id];
            }
        }
    }
}
